        ...
        <CardHeader className="text-center">
          <div className="mx-auto mb-4">
            <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center">
              <span className="text-2xl font-bold text-primary-foreground">ДГ</span>
            </div>
          </div>
          <CardTitle className="text-2xl">Доктор Гаджет</CardTitle>
          <CardDescription>
            {isSignUp 
              ? "Создайте аккаунт для доступа к панели" 
